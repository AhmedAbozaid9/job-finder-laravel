    ...
    <footer class="bg-gray-900 text-gray-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div>
                    <a href="{{ route('jobs.index') }}" class="text-xl font-bold text-indigo-400">{{ $title }}</a>
                ...
                <div>
                    ...
                    <div class="mt-3 flex items-center space-x-3">
                        <a href="#" class="p-2 rounded-md bg-gray-800 hover:bg-gray-700">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-300" viewBox="0 0 24 24" fill="currentColor">
