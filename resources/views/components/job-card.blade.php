    ...
    <article
        ...
        <div class="p-4 flex flex-col h-full">
            <header class="mb-3 flex items-start justify-between gap-3">
                <div class="flex-1">
                    <h3 class="text-base sm:text-lg font-semibold text-slate-900 line-clamp-1">{{ $job->title }}</h3>
            ...
            <div class="text-sm text-slate-700 leading-relaxed mb-4 description line-clamp-2">
                {{ $job->description ?? '' }}
            </div>
